...
| manager.extraVolumeMounts | list | `[]` | Additional volumeMounts on the manager container |
| manager.extraVolumes | list | `[]` | Additional volumes on the manager pod |
